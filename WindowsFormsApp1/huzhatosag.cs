...
{
    internal class huzhatosag: Component
    {
        private Control handleControl;
        //private object DragControl;
        ...
        private void DragForm_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (flag)
            {
                huzhatosag.ReleaseCapture();
                
                huzhatosag.SendMessage(this.SelectControl.FindForm().Handle,161,21,0);
            }
        }
    }
}
